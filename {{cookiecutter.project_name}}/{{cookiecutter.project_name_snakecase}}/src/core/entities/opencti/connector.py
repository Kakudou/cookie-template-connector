...
from {{cookiecutter.project_name_snakecase}}.src.utils.singleton import singleton

if TYPE_CHECKING:
    from {{cookiecutter.project_name_snakecase}}.src.core.entities.opencti.config import Config
    from {{cookiecutter.project_name_snakecase}}.src.core.entities.opencti.octi_helper import (
        OctiHelper,
    )
    from {{cookiecutter.project_name_snakecase}}.src.core.entities.producer import Producer
    from {{cookiecutter.project_name_snakecase}}.src.core.entities.worker import Worker
