...
from {{cookiecutter.project_name_snakecase}}.src.core.usecases.opencti.create_connector.create_connector import CreateConnector
from {{cookiecutter.project_name_snakecase}}.src.core.usecases.opencti.create_connector.create_connector_port_builder import (
